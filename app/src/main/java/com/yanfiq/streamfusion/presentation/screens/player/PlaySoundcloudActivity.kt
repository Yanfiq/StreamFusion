...
import com.yanfiq.streamfusion.data.remote.JsInterface1
import com.yanfiq.streamfusion.data.remote.JsInterface2
...
class WebAppInterface(private val context: Context, private val onReady: () -> Unit, private val onElapsedTimeReceived: (Float) -> Unit) {
    @JavascriptInterface
...
fun soundcloudPlayer(context: Context, trackUrl: String, onReady: () -> Unit, returnWebView: (WebView) -> Unit, returnElapsedTime: (Float) -> Unit){
    ...
    val webView = WebView(context).apply {
        ...
        addJavascriptInterface(
            WebAppInterface(context, onReady, returnElapsedTime),
            "AndroidInterface"
        )
